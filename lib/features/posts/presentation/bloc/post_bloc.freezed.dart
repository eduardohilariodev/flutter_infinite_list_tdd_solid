...
class _$_PostState implements _PostState {
  ...
  @override
  String toString() {
    return 'PostState(status: $status, posts: $posts, hasReachedMax: $hasReachedMax, message: $message)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status,
      const DeepCollectionEquality().hash(_posts), hasReachedMax, message);
...
abstract class _PostState implements PostState {
  const factory _PostState(
      ...
      final bool hasReachedMax,
      final String? message}) = _$_PostState;
